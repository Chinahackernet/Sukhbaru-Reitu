...
基础服务：LAMP或LNMP、Apache、Nginx、MySQL、Perl LAMP、FTP等;



脚本：必须掌握Shell脚本、额外掌握Python、Perl;



网络、安全：TCP/IP协议、tcpdump抓包工具、防火墙配置，如iptables、 ipset。



第一阶段：初级入门初级阶段需要把linux运维学习路线搞清楚，任何学习都是循序渐进的，所以学linux运维也是需要有一定的路线。
...
第二阶段:中级进阶中级进阶需要在充分了解linux原理和基础知识之后，对上层的应用和服务进行深入学习，其中说到服务肯定涉及到网络的相关知识，是需要花时间学习的。
...
7、MySQL应用原理及管理入门(能管理和搭建一个个人博客站点)学到这里，掌握的基本技能，已经够用了，已经能做一些基础的运维工作和简单维护了。
...
5、运维自动化学习(需要学一些开源运维自动化工具的使用如ansible、puppet、cobbler等运维自动化工具)能掌握到这里，基本能处理搞定很多工作了，可以去面试高级运维工程师，差不多薪资能达到12-18K左右。
