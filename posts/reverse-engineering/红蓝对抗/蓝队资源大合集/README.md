...
- [网络外围防御](https://blue.y1ng.org/0x1_blue_team-resources/#_16)
  ...
  - [网络钓鱼意识和报告](https://blue.y1ng.org/0x1_blue_team-resources/#_19)
- [攻防演练](https://blue.y1ng.org/0x1_blue_team-resources/#_20)
- [安全监控](https://blue.y1ng.org/0x1_blue_team-resources/#_21)
  - [端点防护及响应（EDR）](https://blue.y1ng.org/0x1_blue_team-resources/#edr)
  - [网络安全监控（NSM）](https://blue.y1ng.org/0x1_blue_team-resources/#nsm)
  - [安全信息和事件管理（SIEM）](https://blue.y1ng.org/0x1_blue_team-resources/#siem)
  - [服务和性能监控](https://blue.y1ng.org/0x1_blue_team-resources/#_22)
  - [威胁狩猎](https://blue.y1ng.org/0x1_blue_team-resources/#_23)
- [威胁情报](https://blue.y1ng.org/0x1_blue_team-resources/#_24)
- [Tor Onion服务防护](https://blue.y1ng.org/0x1_blue_team-resources/#tor-onion)
- [传输层防护](https://blue.y1ng.org/0x1_blue_team-resources/#_25)
- [基于macOS的防护](https://blue.y1ng.org/0x1_blue_team-resources/#macos)
- [基于Windows的防护](https://blue.y1ng.org/0x1_blue_team-resources/#windows)
- [License](https://blue.y1ng.org/0x1_blue_team-resources/#license)
- [References](https://blue.y1ng.org/0x1_blue_team-resources/#references)
...
另行查阅[Security Information and Event Management (SIEM)](https://blue.y1ng.org/0x1_blue_team-resources/#security-information-and-event-management-siem)和[IR management consoles](https://blue.y1ng.org/0x1_blue_team-resources/#ir-management-consoles).
...
另请参阅 [Security Orchestration, Automation, and Response (SOAR)](https://blue.y1ng.org/0x1_blue_team-resources/#安全编排自动化与响应).
...
Security Information and Event Management (SIEM) - [AlienVault OSSIM](https://www.alienvault.com/open-threat-exchange/projects) - 一个威胁交换（OTX）驱动的单服务器开源SIEM平台，具有资产发现，资产清单，行为监控和事件关联功能。由[AlienVault](https://otx.alienvault.com/)开发 - [Prelude SIEM OSS](https://www.prelude-siem.org/) - 一个开放源码的、无代理的SIEM，有较长的历史和几个商业变体。具有安全事件收集、规范化和从任意日志输入发出警报以及许多流行的监视工具
