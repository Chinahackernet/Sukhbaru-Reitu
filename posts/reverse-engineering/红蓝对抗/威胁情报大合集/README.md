...
| [ZeuS Tracker](https://feodotracker.abuse.ch/)               | Feodo Tracker [abuse.ch](https://abuse.ch/) 跟踪 Feodo 木马  |
...
| [Grey Noise](http://greynoise.io/)                           | Grey Noise 是一个收集、分析互联网范围内扫描器的系统，收集良性扫描器（如 [Shodan.io](https://shodan.io/)）以及恶意扫描（如 SSH 和远程登录蠕虫）的数据 |
...
| [Ransomware Tracker](https://ransomwaretracker.abuse.ch/)    | Ransomware Tracker 由 [abuse.ch](https://abuse.ch/) 提供对与 Ransomware 有关的域名、IP、URL 状态进行跟踪与监视 |
...
| [SSL Blacklist](https://sslbl.abuse.ch/)                     | SSL Blacklist (SSLBL) 是由 [abuse.ch](https://abuse.ch/) 维护的项目，旨在提供一个与恶意软件、僵尸网络活动有关的不良 SSL 证书列表。SSLBL 提供恶意 SSL 证书的 SHA1 指纹，并且提供多种黑名单 |
...
| [URLhaus](https://urlhaus.abuse.ch/)                         | URLhaus 是一个由 [abuse.ch](https://abuse.ch/) 发起的旨在共享用于恶意软件传播的 URL 的项目 |
...
| [ZeuS Tracker](https://zeustracker.abuse.ch/)                | ZeuS Tracker 由 [abuse.ch](https://abuse.ch/) 提供对 ZeuS 的 C&C 主机的跟踪，提供给你域名与主机的黑名单 |
